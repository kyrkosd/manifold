...
class TestZeroMean:
    ...
    def test_nan_ignored_in_mean_computation(self):
        """Nan ignored in mean computation."""
...
class TestUnitVariance:
    ...
    def test_zero_variance_col_safe_std_is_one(self):
        """Zero variance col safe std is one."""
